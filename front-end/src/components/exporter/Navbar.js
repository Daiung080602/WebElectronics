        ...
        return (
            <Nav href="/home" className="flex-column float-start left">
                <div className="fixed-nav">
                    ...
                    <Nav.Item>
                        <Nav.Link className="nav-branch" href={"/exporter/productlines"}>
                            <FaBarcode/>&nbsp;&nbsp;&nbsp;Dòng sản phẩm
                        </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                        <Nav.Link className="nav-branch" href={"/exporter/products"}>
                            <FaBarcode/>&nbsp;&nbsp;&nbsp;Sản phẩm
                        </Nav.Link>
                    </Nav.Item>

                    <Nav.Item>
                        <Nav.Link className="nav-branch" href={"/exporter/lots"}>
                            <FaBarcode/>&nbsp;&nbsp;&nbsp;Lô sản phẩm
                        </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
