        ...
        return (
            <Nav href="/home" className="flex-column float-start left">
                <div className="fixed-nav">
                    <Nav.Item>
                        <Nav.Link id={'home'} className="nav-branch">
                            <FaRecycle/>&nbsp;&nbsp;&nbsp;Product Move
                        </Nav.Link>
                    </Nav.Item>
                    <div>
                        <Nav.Item>
                            <Nav.Link id={'products'} className="nav-branch" href={"/agent/productlines"}>
                                <FaBarcode/>&nbsp;&nbsp;&nbsp;Dòng sản phẩm
                            </Nav.Link>
                        </Nav.Item>
                    </div>
                    <Nav.Item>
                        <Nav.Link id={'employees'} className="nav-branch" href={"/agent/customer"}>
                            <FaUser/>&nbsp;&nbsp;&nbsp;Quản lý khách hàng
                        </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                        <Nav.Item>
                            <Nav.Link id={'products'} className="nav-branch" href={"/agent/products"}>
                                <FaBarcode/>&nbsp;&nbsp;&nbsp;Sản phẩm
                            </Nav.Link>
                        </Nav.Item>
                    </Nav.Item>
